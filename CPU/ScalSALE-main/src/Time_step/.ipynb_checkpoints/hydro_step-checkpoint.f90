...
!        call this%inversed_vertex_mass%Exchange_end()
        ...
        !$omp parallel do simd collapse(1) schedule(simd:static) private(j,i,tmp_mat)
        do k = 1, nz
            do j = 1, ny
                do i = 1, nx
                    do tmp_mat = 1, nmats
        ...
        !$omp parallel do simd collapse(1) schedule(simd:static) private(j,i)
        do k = 1, nz
            do j = 1, ny
                do i = 1, nx
        ...
        do k = 1, this%nzp
            do j = 1, this%nyp
                do i = 1, this%nxp
                    ...
                    ps1 = pressure_sum(i, j, k)
                    ps2 = pressure_sum(i, j, km)
                    ps3 = pressure_sum(im, j, k)
                    ps4 = pressure_sum(im, j, km)
                    ps5 = pressure_sum(i, jm, k)
                    ps6 = pressure_sum(i, jm, km)
                    ...
                    acceleration_x(i, j, k) = -0.25d0 * inversed_vertex_mass(i, j, k) * dt_mid * &
                        ...
                        +ps3 * ((y3 - y4) * (z2 - z4) - (z3 - z4) * (y2 - y4)) &
                        +ps4 * ((y2 - y4) * (z6 - z4) - (z2 - z4) * (y6 - y4)) &
                        +ps5 * ((y1 - y5) * (z3 - z5) - (z1 - z5) * (y3 - y5)) &
                        +ps6 * ((y6 - y5) * (z1 - z5) - (z6 - z5) * (y1 - y5)) &
                        +ps7 * ((y5 - y4) * (z3 - z4) - (z5 - z4) * (y3 - y4)) &
                    ...
                    acceleration_y(i, j, k) = -0.25d0 * inversed_vertex_mass(i, j, k) * dt_mid * &
                        ...
                        +ps3 * ((z3 - z4) * (x2 - x4) - (x3 - x4) * (z2 - z4)) &
                        +ps4 * ((z2 - z4) * (x6 - x4) - (x2 - x4) * (z6 - z4)) &
                        +ps5 * ((z1 - z5) * (x3 - x5) - (x1 - x5) * (z3 - z5)) &
                        +ps6 * ((z6 - z5) * (x1 - x5) - (x6 - x5) * (z1 - z5)) &
                        +ps7 * ((z5 - z4) * (x3 - x4) - (x5 - x4) * (z3 - z4)) &
                    ...
                    acceleration_z(i, j, k) = 0.25d0 * inversed_vertex_mass(i, j, k) * dt_mid * &
                        ...
                        -ps3 * ((x3 - x4) * (y2 - y4) - (y3 - y4) * (x2 - x4)) &
                        -ps4 * ((x2 - x4) * (y6 - y4) - (y2 - y4) * (x6 - x4)) &
                        -ps5 * ((x1 - x5) * (y3 - y5) - (y1 - y5) * (x3 - x5)) &
                        -ps6 * ((x6 - x5) * (y1 - y5) - (y6 - y5) * (x1 - x5)) &
                        -ps7 * ((x5 - x4) * (y3 - y4) - (y5 - y4) * (x3 - x4)) &
                        -ps8 * ((x6 - x4) * (y5 - y4) - (y6 - y4) * (x5 - x4)))
