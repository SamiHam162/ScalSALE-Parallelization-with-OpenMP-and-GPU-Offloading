...
contains
   ...
   subroutine Calculate_rezone_constraint_3d(this, mesh, vert_mass, velocity, mesh_velocity, emfm)
      ...
      vel_rez_max = -1d20
      !$omp parallel do private(k,j,i,vel_diff_x,vel_diff_y,vel_diff_z,len_sq, &
      !$omp vel_grad_i_p,vel_grad_j_p,vel_grad_k_p,vel_grad_i_m,vel_grad_j_m,vel_grad_k_m,vel_grad)
